...
function calculateMDE(baselineConversionRate, perTreatmentTraffic) {
    var alpha = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.05;
    var power = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0.80;
    ...
    for (var a = 0; a < 50; a++) {
        ...
        var calculatedSampleSize = calculateNforMDE(alpha, power, baselineConversionRate, mdeGuess, true);
        var difference = Math.abs((calculatedSampleSize - perTreatmentTraffic) / perTreatmentTraffic);
